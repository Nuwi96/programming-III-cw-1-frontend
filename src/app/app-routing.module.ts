...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'customers', component: CustomerComponent},
      {
        ...
        canActivate: [RoleGuard], data: {roles: ['ROLE_CENTER_MANAGER']}
      },
      ...
      {path: 'center-details', component: CenterDetailComponent, canActivate: [RoleGuard],
        data: {roles: ['ROLE_CENTER_MANAGER']}},
      {path: 'users', component: UsersComponent, canActivate: [RoleGuard], data: {roles: ['ROLE_HEAD_OFFICE_MANAGER']}},
      {path: 'vehicle', component: VehicleComponent, canActivate: [RoleGuard], data: {roles: ['ROLE_HEAD_OFFICE_MANAGER']}},
      {path: 'configuration-screen', component: ConfigurationScreenComponent, canActivate: [RoleGuard],
        data: {roles: ['ROLE_HEAD_OFFICE_MANAGER']}},
      {path: 'daily-limit', component: DailyLimitsComponent, canActivate: [RoleGuard], data: {roles: ['ROLE_HEAD_OFFICE_MANAGER']}},
      {path: 'reports/paddy-report', component: PaddyReportComponent, canActivate: [RoleGuard],
        data: {roles: ['ROLE_HEAD_OFFICE_MANAGER']}},
